...
import com.vaughan.javawebmaster.common.ResultUtils;
import com.vaughan.javawebmaster.constant.UserConstant;
import com.vaughan.javawebmaster.exception.BusinessException;
import com.vaughan.javawebmaster.exception.ThrowUtils;
import com.vaughan.javawebmaster.model.dto.user.*;
...
//    private WxOpenConfig wxOpenConfig;
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        if (StringUtils.isAnyBlank(userAccount, userPassword, checkPassword)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);//模拟缺少信息但还是提交申请的场景
        }
...
//    @GetMapping("/login/wx_open")
     ...
     * @param httpServletRequest
     * @return 返回查询结果，如果根据传入的数据找得到这个结果则返回，如果找不到。。。
     */
